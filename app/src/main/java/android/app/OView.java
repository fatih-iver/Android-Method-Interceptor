...
public class OView extends View {
    ...
    public OView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public OView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public OView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
